...
class EquipmentController < ApplicationController
  ...
  # GET /equipment.json
  def index
    @equipment = Equipment.search(params[:search], params[:type], params[:location], params[:state]).order(sort_column + " " + sort_direction).paginate(:page => params[:page], :per_page => 10)
